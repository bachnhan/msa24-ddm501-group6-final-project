...
MODEL_LOADED = Gauge("ml_model_loaded", "Current model load status (1=OK, 0=Fail)")
MODEL_LAST_RELOAD = Gauge(
    "ml_model_last_reload_seconds", "Timestamp of last model reload"
)
MODEL_INFO = Info("ml_model_info", "Model metadata")
...
PREDICTION_LATENCY = Histogram(
    "ml_prediction_duration_seconds", "Time taken for churn prediction in seconds"
)
PREDICTION_VALUE = Histogram("ml_prediction_value", "Distribution of prediction values")
